...
@Test func recommendedHiddenTrafficLightCopyIsLocalized() {
    #expect(I18n.string("settings.hiddenTrafficLights", language: "zh-Hans") == "隐藏式红绿灯（推荐）")
    #expect(I18n.string("settings.hiddenTrafficLights", language: "en") == "Hidden Traffic Lights (Recommended)")
    #expect(I18n.string("reveal.group", language: "zh-Hans") == "整组")
    #expect(I18n.string("reveal.group", language: "en") == "Group")
    #expect(I18n.string("reveal.nearest", language: "zh-Hans") == "单个（推荐）")
    #expect(I18n.string("reveal.nearest", language: "en") == "Single (Recommended)")
}
