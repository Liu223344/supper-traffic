...
enum ControlStyle: String, CaseIterable {
    ...
    var title: String {
        switch self {
        case .macOS: return I18n.string("style.macOS")
        case .edgeSquares: return I18n.string("style.edgeSquares")
        }
    }
}
...
enum HiddenTrafficLightRevealMode: String, CaseIterable {
    ...
    var title: String {
        switch self {
        case .group: return I18n.string("reveal.group")
        case .nearest: return I18n.string("reveal.nearest")
        }
    }
}
